...
Ongnyeon-dong, 21946, South Korea</p>
      ...
      <div class="w-full sm:w-1/5 flex-1 sm:flex flex-col space-y-4">
        <a href="/" class="opacity-60 w-1/2 inline-flex">Home</a>
      ...
      <div class="w-full sm:w-1/5 flex-1 sm:flex flex-col space-y-4">
        <a href="<?php echo G5_URL ?>/notice" class="opacity-60 w-1/2 sm:w-full inline-flex mt-2 sm:mt-0">Notice</a>
        <a href="<?php echo G5_URL ?>/webzine" class="opacity-60 w-1/2 sm:w-full">Webzine</a>
        <a href="<?php echo G5_URL ?>/qa" class="opacity-60 w-1/2 sm:w-full inline-flex">Q&A</a>
        <!-- <a href="#testimonials" class="opacity-60 w-1/2 sm:w-full inline-flex">광고 안내</a> -->
        <a href="<?php echo G5_BBS_URL ?>/content.php?co_id=privacy" class="opacity-60 w-1/2 sm:w-full">Privacy</a>
