...
define('G5_MYSQL_HOST', 'mysql57bsdb.hosting.kr');
define('G5_MYSQL_USER', 'hkgziw3rvuoqsjiv_enuser');
define('G5_MYSQL_PASSWORD', 'Zxasqw12@@!!');
define('G5_MYSQL_DB', 'hkgziw3rvuoqsjiv_en');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '97b2fc274a549283dfcc54c381ceb98c'); // 토큰 암호화에 사용할 키
